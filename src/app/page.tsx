    ...
    <main className="editorial-container">
      ...
      */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:h-[calc(100vh-4rem)] lg:overflow-hidden items-start">
        ...
        {/* Left Column: Anchored sidebar — fixed, independent scroll without visible bar on desktop */}
        <div className="lg:col-span-4 xl:col-span-4 lg:h-full lg:overflow-y-auto no-scrollbar py-6 sm:py-8 lg:py-6">
