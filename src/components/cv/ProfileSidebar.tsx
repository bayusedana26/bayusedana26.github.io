...
export const ProfileSidebar: React.FC<ProfileSidebarProps> = ({ onOpenCv }) => {
  ...
  return (
    <aside className="w-full h-full flex flex-col">
      <div className="w-full flex-1 p-5 sm:p-6 lg:p-6 xl:p-7 space-y-5">
        {/* ── Status Header: Availability + GMT+7 Live Clock ── */}
        <div className="flex items-center justify-between gap-2 pb-3 border-b border-editorial-light-border/60 dark:border-editorial-dark-border/60">
          <div className="inline-flex items-center space-x-2 text-xs font-mono font-medium text-emerald-700 dark:text-emerald-400">
          ...
          {gmtTime && (
            <div className="inline-flex items-center space-x-1.5 text-[11px] font-mono text-editorial-light-muted dark:text-editorial-dark-muted shrink-0">
        ...
        {/* ── Personal Identity: Photo + Name + Professional Title ── */}
        <div className="flex items-start space-x-4">
          {/* Interactive photo triggering CV preview */}
          <button
            type="button"
            onClick={onOpenCv}
            title={language === "id" ? "Klik untuk pratinjau CV" : "Click to preview CV"}
            className="relative w-20 h-24 sm:w-22 sm:h-26 rounded-xl border border-editorial-light-border dark:border-editorial-dark-border overflow-hidden shrink-0 shadow-2xs bg-neutral-950 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-editorial-light-accent ring-1 ring-black/5 dark:ring-white/10"
          >
            <Image
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end justify-center pb-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          ...
          <div className="min-w-0 flex-1 space-y-1">
            <h1 className="text-xl sm:text-2xl font-extrabold tracking-tight text-editorial-light-text dark:text-editorial-dark-text leading-tight">
              Bayu Sedana
            </h1>
            <p className="text-xs sm:text-sm font-semibold text-editorial-light-accent dark:text-editorial-dark-accent leading-snug">
              Software &amp; Data Specialist
            </p>
            <div className="flex items-center space-x-1.5 text-xs font-mono text-editorial-light-muted dark:text-editorial-dark-muted pt-0.5">
        ...
        <div className="grid grid-cols-3 gap-2">
          <a
            ...
            className="flex items-center justify-center space-x-1.5 px-2.5 py-2 min-h-[38px] rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold transition-all shadow-2xs hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
          >
          ...
          <a
            ...
            className="flex items-center justify-center space-x-1.5 px-2.5 py-2 min-h-[38px] rounded-lg border border-editorial-light-border dark:border-editorial-dark-border bg-editorial-light-bg/80 dark:bg-editorial-dark-bg/80 hover:bg-editorial-light-surface dark:hover:bg-editorial-dark-surface hover:border-editorial-light-accent dark:hover:border-editorial-dark-accent text-editorial-light-text dark:text-editorial-dark-text text-xs font-semibold transition-all hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-editorial-light-accent"
          >
        ...
        <div className="grid grid-cols-3 divide-x divide-editorial-light-border/60 dark:divide-editorial-dark-border/60 py-2.5 border-y border-editorial-light-border/60 dark:border-editorial-dark-border/60">
          {milestones.map((m) => (
            <div key={m.number} className="text-center px-1">
              <span className="block text-base sm:text-lg font-bold font-mono text-editorial-light-text dark:text-editorial-dark-text leading-none">
                {m.number}
              </span>
              <span className="block text-[10px] font-mono text-editorial-light-muted dark:text-editorial-dark-muted mt-1 leading-none">
        ...
        <div className="space-y-2.5 pt-3 border-t border-editorial-light-border/60 dark:border-editorial-dark-border/60">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono uppercase tracking-wider text-editorial-light-accent dark:text-editorial-dark-accent font-bold">
